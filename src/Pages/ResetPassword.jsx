    ...
    <div className="h-[calc(100vh-72px)] bg-secBackground flex items-center transition-all duration-300 dark:text-mainText">
      <div className="container flex justify-center">
        <div className="w-[500px] bg-form rounded-lg shadow-lg dark:shadow-dark px-7 py-5">
          <h1 className="text-center text-4xl font-bold relative after:content=[''] after:w-[50px] after:h-[5px] after:bg-primary after:absolute after:bottom-[-20px] after:left-1/2 after:-translate-x-1/2">
            Password Reset
          </h1>
